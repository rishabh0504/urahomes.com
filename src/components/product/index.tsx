...
// Chakra imports
import { Avatar, AvatarGroup, Box, Flex, Button, Icon, Image, Text, useColorModeValue } from '@chakra-ui/react';
// Assets
...
function Product() {
  ...
  return (
    <Flex borderRadius='20px' bg={boxBg} h='345px' w={{ base: '315px', md: '345px' }} direction='column'>
      <Box p='20px'>
        <Flex w='100%' mb='10px'>
      ...
      <Flex
        ...
        direction='column'
      >
        <Text fontSize='sm' color='gray.500' lineHeight='24px' pe='40px' fontWeight='500' mb='auto'>
        ...
        <Flex>
          ...
          <Flex>
            <Icon as={MdVideoLibrary} w='20px' h='20px' me='6px' color='red.500' />
            <Text color={mainText} fontSize='sm' my='auto' fontWeight='500'>
              Video Format
            </Text>
          </Flex>
